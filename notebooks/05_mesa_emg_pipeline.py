...
from src.emg_features import extract_emg_features_all_epochs
...
for edf_path in tqdm(selected_files, desc='Processing EMG'):
    try:
        ...
        data = raw.get_data()   # shape: (1, n_samples)
        sr = raw.info['sfreq']
        ...
        # Reshape to (n_epochs, 1, samples_per_epoch)
        epochs = data.reshape(
            1,
            n_epochs,
            samples_per_epoch
        ...
        # Extract features
        X = extract_emg_features_all_epochs(epochs, sr)
...
output_path = results_dir / 'mesa_emg_features_aligned.npz'
